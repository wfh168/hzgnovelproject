...
public class ChapterServiceImpl extends ServiceImpl<ChapterMapper, Chapter> implements ChapterService {
     ...
     */
    @Override
    public void insertChaptersToDatabase(List<Chapter> chapters, Long novelId) {
        for (Chapter chapter : chapters) {
            ...
            System.out.println("插入成功: " + chapter.getTitle());
        }
    }
    ...
    public List<String> getChapterTitles(Long novelId, String novelName) {
        ...
        if (novelName != null) {
            ...
            novelQueryWrapper.eq("title", novelName);
            Novel novel = novelMapper.selectOne(novelQueryWrapper);
            ...
            if (novelId != null && !novelId.equals(novel.getId())) {
                // 如果 ID 不匹配，抛出异常
                throw new RuntimeException("提供的小说ID与小说名称不匹配！");
            }

            // 使用查询到的 novelId 来查询章节
            queryWrapper.eq("novel_id", novel.getId());
        }
